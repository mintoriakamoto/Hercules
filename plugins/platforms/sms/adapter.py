...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Hercules gateway adapter.

    Each inbound phone number gets its own Hercules session (multi-tenant).
...
# static dict in hercules_cli/gateway.py, and the _send_sms dispatch in
