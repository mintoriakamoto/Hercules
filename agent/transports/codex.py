...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Hercules's web-provider config and
        ...
        # native search engine for xAI sessions instead of Hercules's
        # configured web provider (Tavily/etc.), and those results bypass
        # Hercules's tool-trace / citation plumbing (they arrive baked into the
