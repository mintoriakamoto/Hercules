...
Built for [Hercules Agent](https://github.com/mintoriakamoto/Hercules). Usable in any coding agent. Canonical source lives here; synced to [`mintoriakamoto/Hercules/skills/creative/ascii-video`](https://github.com/mintoriakamoto/Hercules/tree/main/skills/creative/ascii-video) via PR.
