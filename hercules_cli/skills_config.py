...
`hercules skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.hercules/config.yaml under:
...
from hercules_cli.config import cfg_get, load_config, save_config
from hercules_cli.colors import Colors, color
from hercules_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `hercules skills`."""
    from hercules_cli.curses_ui import curses_checklist
