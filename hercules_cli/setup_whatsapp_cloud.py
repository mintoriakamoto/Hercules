...
Entry point: ``hercules whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``hercules_cli/main.py``).
...
Hercules gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Hercules to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Hercules needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Hercules gateway in another terminal:")
    print("         hercules gateway")
    print()
