...
``cli.py``'s ``HerculesCLI`` class. ``HerculesCLI`` inherits ``CLICommandsMixin`` so
...
from hercules_constants import display_hercules_home, is_termux as _is_termux_environment
...
class CLICommandsMixin:
    ...
    def _handle_rollback_command(self, command: str):
        ...
        if not mgr.enabled:
            ...
            print("  Enable with: hercules --checkpoints")
    ...
    def _handle_snapshot_command(self, command: str):
        ...
        if subcmd in {"list", "ls"}:
            ...
            if not snaps:
                ...
                return
            print(f"  State snapshots ({display_hercules_home()}/state-snapshots/):\n")
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        """Handle /journey — the learning timeline (see `hercules journey`).
        ...
        from cli import _cprint
        from hercules_cli.journey import register_cli
    ...
    def _handle_paste_command(self):
        ...
        from hercules_cli.clipboard import has_clipboard_image
    ...
    def _handle_image_command(self, cmd_original: str):
        ...
        if _remainder:
            ...
            _cprint(f"  {_DIM}Tip: type your next message, or run hercules chat -q --image {_termux_example_image_path(image_path.name)} \"What do you see?\"{_RST}")
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in hercules_cli/colors.py
    ...
    def _handle_handoff_command(self, cmd_original: str) -> bool:
        ...
        try:
            ...
            pass
        _cprint("  Timed out waiting for the gateway. Is `hercules gateway` running?")
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if not target:
            ...
            if self._show_recent_sessions(reason="resume"):
                ...
                return
            _cprint("  Tip:   Use /history or `hercules sessions list` to find sessions.")
            return
        ...
        if target.isdigit():
            ...
            from hercules_cli.main import _resolve_session_by_name_or_id
        ...
        if not session_meta:
            ...
            _cprint("  Use /history or `hercules sessions list` to see available sessions.")
            return
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from hercules_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_suggestions_command(self, cmd: str):
        ...
        args = " ".join(tokens)
        try:
            from hercules_cli.suggestions_cmd import handle_suggestions_command
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from hercules_cli.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to hercules_cli.curator so the CLI and the `hercules curator`
        ...
        try:
            from hercules_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_kanban_command(self, cmd: str):
        ...
        """
        from hercules_cli.kanban import run_slash
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to hercules_cli.skills_hub."""
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            from hercules_cli.write_approval_commands import handle_pending_subcommand
            ...
            if out is not None:
                print(out)
                return
        from hercules_cli.skills_hub import handle_skills_slash
    ...
    def _handle_bundles_command(self, cmd: str) -> None:
        ...
        Mirrors ``hercules bundles list`` but renders inside the running
        ...
        if not bundles:
            ...
            _cprint(
                f"  {_DIM}Create one with: hercules bundles create "
        ...
        _cprint(
            ...
            f"Manage with `hercules bundles`.{_RST}"
        )
        ...
        if sub.startswith("connect"):
            ...
            if hasattr(self, '_pending_input'):
                self._pending_input.put(
                    ...
                    "just because CDP is connected. This is typically a Hercules-managed isolated debug "
    ...
    def _handle_goal_command(self, cmd: str) -> None:
        ...
        from hercules_cli.goals import parse_contract
    ...
    def _handle_goal_draft(self, objective: str) -> None:
        ...
        from cli import _DIM, _RST, _cprint
        from hercules_cli.goals import draft_contract
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from hercules_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
        ...
        if len(parts) < 2 or not parts[1].strip():
            ...
            print("\n  Usage: /skin <name>")
            print(f"  Custom skins: drop a YAML file in {display_hercules_home()}/skins/\n")
            return
    ...
    def _compose_in_editor(self, initial_text: str = "") -> str:
        ...
        fd, path = tempfile.mkstemp(suffix=".md", prefix="hercules_prompt_")
        try:
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from hercules_cli.models import _is_anthropic_fast_model
    ...
    def _handle_update_command(self) -> bool:
        ...
        ``hercules update`` so the user sees update output directly and gets
        ...
        when cancelled.
        """
        from hercules_cli.config import is_managed, format_managed_message
        ...
        raw = self._prompt_text_input_modal(
            ...
            detail="This will exit the current session and run `hercules update`.",
            choices=choices,
        )
        if raw is None:
