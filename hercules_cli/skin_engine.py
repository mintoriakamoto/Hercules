"""Hercules CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.hercules/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    set_active_skin("mytheme")            # Switch to user skin from ~/.hercules/skins/
...
Drop a YAML file in ``~/.hercules/skins/<name>.yaml`` following the schema above.
...
def _skins_dir() -> Path:
    ...
    return get_hercules_home() / "skins"
