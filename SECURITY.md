...
Report privately via [GitHub Security Advisories](https://github.com/mintoriakamoto/Hercules/security/advisories/new)
or [GitHub private vulnerability reporting](https://github.com/mintoriakamoto/Hercules/security/advisories/new). Do not open public issues for
...
- Environment details (`hercules version`, commit SHA, OS, Python
  version).
...
- **Documented break-glass settings.** Operator-selected trade-offs
  ...
  hercules-home security, and similar. Reports against those
...
- **Community-contributed skills and plugins.** Third-party skills
  ...
  reviewed, not a vulnerability in Hercules Agent. Bugs in Hercules
