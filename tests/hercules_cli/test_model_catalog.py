"""Tests for hercules_cli.model_catalog — remote manifest fetch + cache + fallback."""
...
def isolated_home(tmp_path, monkeypatch):
    """Isolate HERCULES_HOME + reset any module-level catalog cache per test."""
...
class TestValidation:
    def test_accepts_well_formed_manifest(self, isolated_home):
        from hercules_cli.model_catalog import _validate_manifest
...
class TestFallbackChain:
    ...
    PRIMARY = "https://mintoriakamoto.github.io/Hercules/docs/api/model-catalog.json"
    FALLBACK = (
        "https://raw.githubusercontent.com/mintoriakamoto/Hercules"
