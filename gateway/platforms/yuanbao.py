...
try:
    ...
    _HERCULES_VERSION = "0.0.0"

_APP_VERSION = _HERCULES_VERSION
_BOT_VERSION = _HERCULES_VERSION
_YUANBAO_INSTANCE_ID = str(HERCULES_INSTANCE_ID)  # single source: yuanbao_proto.HERCULES_INSTANCE_ID
