#!/usr/bin/env python3
"""
SWE Runner with Hercules Trajectory Format

A runner that uses Hercules-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Hercules-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Hercules-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Hercules format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Hercules-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Hercules-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Hercules Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Hercules-Agent's built-in execution environments
    and outputs trajectories in Hercules-Agent format.
    """
    ...
    def _convert_to_hercules_format(
        self,
        ...
        """
        Convert internal message format to Hercules trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Hercules trajectory format
        trajectory = self._convert_to_hercules_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Hercules trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Hercules Trajectory Format")
    print("=" * 60)
