...
from hercules_constants import OPENROUTER_BASE_URL, get_hercules_home
from agent.retry_utils import jittered_backoff

# Load .env from HERCULES_HOME first, then project root as a dev fallback.
        ...
        if provider:
            ...
            if client is None:
                raise RuntimeError(
                    ...
                    f"Check your API key or run: hercules setup")
