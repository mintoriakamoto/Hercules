...
export const en: Translations = {
  ...
  status: {
    ...
    restartGatewayConfirmMessage:
      "This restarts the Hercules gateway process. Connected channels and active sessions will reconnect afterward.",
    ...
    stopped: "Stopped",
    updateHercules: "Update Hercules",
    updateHerculesConfirmMessage:
      "This runs hercules update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateHerculesConfirmNow: "Update now",
    updateHerculesConfirmTitle: "Update Hercules?",
    updatingHercules: "Updating Hercules…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Hercules plugins (`hercules plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.hercules/plugins/?",
    removeHint: "Only user-installed plugins under ~/.hercules/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.hercules/skills/",
  ...
  config: {
    configPath: "~/.hercules/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Hercules doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Hercules Achievements",
      subtitle:
        "Collectible Hercules badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Hercules session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Hercules more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Hercules sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Hercules is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
