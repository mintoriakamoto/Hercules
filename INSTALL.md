...
Every release on the [Releases page](https://github.com/mintoriakamoto/Hercules/releases)
...
land on [GHCR](https://github.com/mintoriakamoto/Hercules/pkgs/container/hercules-agent)
with every push to `main`.

```bash
# Install the release wheel directly (fully bundled build):
pip install https://github.com/mintoriakamoto/Hercules/releases/latest/download/hercules_agent-1.0.0-py3-none-any.whl
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/mintoriakamoto/Hercules/main/scripts/install.sh | bash -s -- --skip-browser   # no Playwright/Chromium
curl -fsSL https://raw.githubusercontent.com/mintoriakamoto/Hercules/main/scripts/install.sh | bash -s -- --no-venv --skip-setup
curl -fsSL https://raw.githubusercontent.com/mintoriakamoto/Hercules/main/scripts/install.sh | bash -s -- --branch <name>  # install a specific branch
```
