...
Only included in the hercules-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Hercules-Agent (https://github.com/NousResearch/hercules-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_hercules_home() / "cache" / "discord_capabilities.json"
