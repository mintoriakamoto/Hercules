...
Trust levels:
  - builtin:   Ships with Hercules. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hercules/\.env|\~/\.hercules/\.env',
     "hercules_env_access", "critical", "exfiltration",
     "directly references Hercules secrets file"),
    ...
    (r'\.hercules/config\.yaml|\.hercules/SOUL\.md',
     "hercules_config_mod", "critical", "persistence",
     "references Hercules configuration files directly"),
...
# scan. `.skillignore` is the Hercules-native name; `.clawhubignore` is honored
