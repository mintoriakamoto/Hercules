...
const config: Config = {
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-hercules-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/mintoriakamoto/Hercules/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/hercules-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/mintoriakamoto/Hercules/',
          label: 'Download',
          position: 'left',
        },
        {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'GitHub Issues', href: 'https://github.com/mintoriakamoto/Hercules/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://github.com/mintoriakamoto/Hercules/' },
            { label: 'GitHub', href: 'https://github.com/mintoriakamoto/Hercules' },
          ],
        },
      ],
