#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Hercules docs site.
...
Both publish at:
  https://github.com/mintoriakamoto/Hercules/docs/llms.txt
  https://github.com/mintoriakamoto/Hercules/docs/llms-full.txt
...
SITE_BASE = "https://github.com/mintoriakamoto/Hercules/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Hercules as a Python Library", None),
        ("guides/use-mcp-with-hercules", "Use MCP with Hercules", None),
        ("guides/use-voice-mode-with-hercules", "Use Voice Mode with Hercules", None),
        ("guides/use-soul-with-hercules", "Use SOUL.md with Hercules", None),
        ("guides/build-a-hercules-plugin", "Build a Hercules Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Hercules"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "Hercules/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/mintoriakamoto/Hercules")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://github.com/mintoriakamoto/Hercules/docs\n",
        "Short index: https://github.com/mintoriakamoto/Hercules/docs/llms.txt\n",
        "\n---\n\n",
    ]
