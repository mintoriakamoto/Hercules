...
| | |
|---|---|
| Source | Optional — install with `hercules skills install official/mlops/qdrant` |
...
- **[Advanced Usage](https://github.com/mintoriakamoto/Hercules/blob/main/optional-skills/mlops/qdrant/references/advanced-usage.md)** - Distributed mode, hybrid search, recommendations
- **[Troubleshooting](https://github.com/mintoriakamoto/Hercules/blob/main/optional-skills/mlops/qdrant/references/troubleshooting.md)** - Common issues, debugging, performance tuning
