    ...
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          ...
          describes how they use Hercules &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        ...
        <a
          href="https://github.com/mintoriakamoto/Hercules/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://github.com/mintoriakamoto/Hercules/discussions" target="_blank" rel="noopener noreferrer">
