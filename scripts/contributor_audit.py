...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Hercules\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "hercules@nousresearch.com",
    "hercules-audit@example.com",
    "hercules@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/hercules-agent",
                "--state", "merged",
