...
Useful when adding a keybinding to Hercules (or any prompt_toolkit app) and you
...
Then in Hercules, bind the newline behaviour to that key:
    @kb.add('c-j')
...
def main() -> None:
    ...
    @kb.add("<any>")
    def _on_any(event):  # prompt_toolkit event type
        parts = []
