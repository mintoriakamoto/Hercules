...
HERCULES_HOME = Path(os.getenv("HERCULES_HOME", Path.home() / ".hercules"))
...
def check_config(groq_key, eleven_key):
    ...
    # Voice mode state
    voice_mode_path = HERCULES_HOME / "gateway_voice_mode.json"
