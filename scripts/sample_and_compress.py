...
DEFAULT_DATASETS = [
    ...
    "NousResearch/hercules-agent-megascience-sft1",
    "NousResearch/Hercules-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Hercules-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-hercules-agent"
]
